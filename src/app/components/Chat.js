      ...
      {!joined ? (
        ...
        <>
          ...
          <div className="mt-4 flex">
            ...
            />
            <button onClick={sendMessage} className="p-2 bg-blue-600 hover:bg-blue-700 rounded-r">
              Send
            </button>
          </div>
          ...
          <div className="mt-4">
            ...
            />
            <button onClick={sendPrivateMessage} className="ml-2 p-2 bg-purple-600 hover:bg-purple-700 rounded">
              Send DM
            </button>
          </div>
